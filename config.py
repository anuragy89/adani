...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/anuragy89/adani.git",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/thehellsupport")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/thehellsupport")
